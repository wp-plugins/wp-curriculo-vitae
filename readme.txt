...
O **WP-Curriculo Vitae** e um plugin que permite que usuarios a cadastrem seu curriculo no site para divulgacao online ou para uso do site.
...
* Um painel que esta em ferramentas Configuracoes - WP-Curriculo Vitae, primeira aba exibe as informacoes do plugin e um email para suporte, na segunda aba exibe lista com todos os registros cadastrado, possibilitando excluir o mesmo.
...
1. Atualizacao no layout;
2. Configurações de e-mail;
3. Ajustado o campo do celular;
4. Ajuste nas mensagens de sucesso quando cadastrado;
5. Ajuste nas mensagens do corpo dos e-mails enviado quando tem novo cadastro;
6. Ajuste no formulário de cadastro;

= 4.5.4 =

1. Ajuste nos campos textarea;
2. Otimização do plugin;

= 4.5.5 =

1. Ajuste no menu configuracoes de e-mails;
...
1. Ajuste do envio de email de notificação;
